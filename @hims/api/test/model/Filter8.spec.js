...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Filter8();
  });
  ...
  describe('Filter8', function() {
    it('should create an instance of Filter8', function() {
      // uncomment below and update the code to test Filter8
      //var instane = new HimsApiClient.Filter8();
      //expect(instance).to.be.a(HimsApiClient.Filter8);
    });
