...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.BasebenefitplansFields();
  });
  ...
  describe('BasebenefitplansFields', function() {
    it('should create an instance of BasebenefitplansFields', function() {
      // uncomment below and update the code to test BasebenefitplansFields
      //var instane = new HimsApiClient.BasebenefitplansFields();
      //expect(instance).to.be.a(HimsApiClient.BasebenefitplansFields);
    });
