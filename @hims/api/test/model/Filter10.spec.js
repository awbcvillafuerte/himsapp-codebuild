...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Filter10();
  });
  ...
  describe('Filter10', function() {
    it('should create an instance of Filter10', function() {
      // uncomment below and update the code to test Filter10
      //var instane = new HimsApiClient.Filter10();
      //expect(instance).to.be.a(HimsApiClient.Filter10);
    });
