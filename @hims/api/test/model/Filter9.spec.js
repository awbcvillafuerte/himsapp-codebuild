...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Filter9();
  });
  ...
  describe('Filter9', function() {
    it('should create an instance of Filter9', function() {
      // uncomment below and update the code to test Filter9
      //var instane = new HimsApiClient.Filter9();
      //expect(instance).to.be.a(HimsApiClient.Filter9);
    });
