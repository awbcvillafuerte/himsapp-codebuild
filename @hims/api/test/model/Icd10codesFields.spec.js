...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Icd10codesFields();
  });
  ...
  describe('Icd10codesFields', function() {
    it('should create an instance of Icd10codesFields', function() {
      // uncomment below and update the code to test Icd10codesFields
      //var instane = new HimsApiClient.Icd10codesFields();
      //expect(instance).to.be.a(HimsApiClient.Icd10codesFields);
    });
