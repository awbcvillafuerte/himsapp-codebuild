...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Filter15();
  });
  ...
  describe('Filter15', function() {
    it('should create an instance of Filter15', function() {
      // uncomment below and update the code to test Filter15
      //var instane = new HimsApiClient.Filter15();
      //expect(instance).to.be.a(HimsApiClient.Filter15);
    });
