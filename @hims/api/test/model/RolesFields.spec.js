...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.RolesFields();
  });
  ...
  describe('RolesFields', function() {
    it('should create an instance of RolesFields', function() {
      // uncomment below and update the code to test RolesFields
      //var instane = new HimsApiClient.RolesFields();
      //expect(instance).to.be.a(HimsApiClient.RolesFields);
    });
