...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Filter13();
  });
  ...
  describe('Filter13', function() {
    it('should create an instance of Filter13', function() {
      // uncomment below and update the code to test Filter13
      //var instane = new HimsApiClient.Filter13();
      //expect(instance).to.be.a(HimsApiClient.Filter13);
    });
