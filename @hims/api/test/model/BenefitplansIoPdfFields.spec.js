...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.BenefitplansIoPdfFields();
  });
  ...
  describe('BenefitplansIoPdfFields', function() {
    it('should create an instance of BenefitplansIoPdfFields', function() {
      // uncomment below and update the code to test BenefitplansIoPdfFields
      //var instane = new HimsApiClient.BenefitplansIoPdfFields();
      //expect(instance).to.be.a(HimsApiClient.BenefitplansIoPdfFields);
    });
