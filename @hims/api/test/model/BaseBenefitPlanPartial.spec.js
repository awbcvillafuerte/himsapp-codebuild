...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.BaseBenefitPlanPartial();
  });
  ...
  describe('BaseBenefitPlanPartial', function() {
    it('should create an instance of BaseBenefitPlanPartial', function() {
      // uncomment below and update the code to test BaseBenefitPlanPartial
      //var instane = new HimsApiClient.BaseBenefitPlanPartial();
      //expect(instance).to.be.a(HimsApiClient.BaseBenefitPlanPartial);
    });
