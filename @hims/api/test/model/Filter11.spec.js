...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Filter11();
  });
  ...
  describe('Filter11', function() {
    it('should create an instance of Filter11', function() {
      // uncomment below and update the code to test Filter11
      //var instane = new HimsApiClient.Filter11();
      //expect(instance).to.be.a(HimsApiClient.Filter11);
    });
