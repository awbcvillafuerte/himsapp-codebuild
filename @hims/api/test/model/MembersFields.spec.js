...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.MembersFields();
  });
  ...
  describe('MembersFields', function() {
    it('should create an instance of MembersFields', function() {
      // uncomment below and update the code to test MembersFields
      //var instane = new HimsApiClient.MembersFields();
      //expect(instance).to.be.a(HimsApiClient.MembersFields);
    });
