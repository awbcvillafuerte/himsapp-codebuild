...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimsApiClient.Filter14();
  });
  ...
  describe('Filter14', function() {
    it('should create an instance of Filter14', function() {
      // uncomment below and update the code to test Filter14
      //var instane = new HimsApiClient.Filter14();
      //expect(instance).to.be.a(HimsApiClient.Filter14);
    });
