    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('registered_name')) {
                obj['registered_name'] = ApiClient.convertToType(data['registered_name'], 'Boolean');
            }
            if (data.hasOwnProperty('brand_name')) {
                obj['brand_name'] = ApiClient.convertToType(data['brand_name'], 'Boolean');
            }
            if (data.hasOwnProperty('name_on_card')) {
                obj['name_on_card'] = ApiClient.convertToType(data['name_on_card'], 'Boolean');
            }
            if (data.hasOwnProperty('corporate_account_no')) {
                obj['corporate_account_no'] = ApiClient.convertToType(data['corporate_account_no'], 'Boolean');
            }
            if (data.hasOwnProperty('tin_no')) {
                obj['tin_no'] = ApiClient.convertToType(data['tin_no'], 'Boolean');
            }
            if (data.hasOwnProperty('vat_type')) {
                obj['vat_type'] = ApiClient.convertToType(data['vat_type'], 'Boolean');
            }
            if (data.hasOwnProperty('evat_no')) {
                obj['evat_no'] = ApiClient.convertToType(data['evat_no'], 'Boolean');
            }
            if (data.hasOwnProperty('industry')) {
                obj['industry'] = ApiClient.convertToType(data['industry'], 'Boolean');
            }
            if (data.hasOwnProperty('ownership')) {
                obj['ownership'] = ApiClient.convertToType(data['ownership'], 'Boolean');
            }
            if (data.hasOwnProperty('years_of_existence')) {
                obj['years_of_existence'] = ApiClient.convertToType(data['years_of_existence'], 'Boolean');
            }
            if (data.hasOwnProperty('prev_hmo_provider')) {
                obj['prev_hmo_provider'] = ApiClient.convertToType(data['prev_hmo_provider'], 'Boolean');
            }
            if (data.hasOwnProperty('agent_name')) {
                obj['agent_name'] = ApiClient.convertToType(data['agent_name'], 'Boolean');
            }
            if (data.hasOwnProperty('sec_reg_no')) {
                obj['sec_reg_no'] = ApiClient.convertToType(data['sec_reg_no'], 'Boolean');
            }
            if (data.hasOwnProperty('tel_no')) {
                obj['tel_no'] = ApiClient.convertToType(data['tel_no'], 'Boolean');
            }
            if (data.hasOwnProperty('authorized_signatory')) {
                obj['authorized_signatory'] = ApiClient.convertToType(data['authorized_signatory'], 'Boolean');
            }
            if (data.hasOwnProperty('sources_of_funds')) {
                obj['sources_of_funds'] = ApiClient.convertToType(data['sources_of_funds'], 'Boolean');
            }
            if (data.hasOwnProperty('sales_channel')) {
                obj['sales_channel'] = ApiClient.convertToType(data['sales_channel'], 'Boolean');
            }
            if (data.hasOwnProperty('main_office_address')) {
                obj['main_office_address'] = ApiClient.convertToType(data['main_office_address'], 'Boolean');
            }
            if (data.hasOwnProperty('branches')) {
                obj['branches'] = ApiClient.convertToType(data['branches'], 'Boolean');
            }
            if (data.hasOwnProperty('contact_numbers')) {
                obj['contact_numbers'] = ApiClient.convertToType(data['contact_numbers'], 'Boolean');
            }
            if (data.hasOwnProperty('contact_persons')) {
                obj['contact_persons'] = ApiClient.convertToType(data['contact_persons'], 'Boolean');
            }
