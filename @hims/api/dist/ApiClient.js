...
function () {
  function ApiClient() {
     ...
     * @type {String}
     * @default https://neo-local.seerlabs.com/api
     */
    this.basePath = 'https://neo-local.seerlabs.com/api'.replace(/\/+$/, '');
    /**
  ...
  _createClass(ApiClient, [{
    ...
    */
    ...
    value: function hostSettings() {
      return [{
        'url': "https://neo-local.seerlabs.com/api",
        'description': "No description provided"
      }, {
        'url': "https://hims-api.veridata.com.ph/v1",
        'description': "No description provided"
      }];
    }
  }, {
