...
export const Account: React.FC<IAccountsProps> = (
  props: IAccountsProps,
): JSX.Element => {
    ...
    <>
      <Grid container spacing={5}>
        ...
        <Grid item xs={6}>
          ...
          <Typography className={classes.value}>
            {props.userData.username ? props.userData.username : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography className={classes.label}>
            PRIMARY ROLE AND MODULE
          </Typography>
      ...
      <Grid container spacing={5}>
        <Grid item xs={6}>
          ...
          <Typography className={classes.value}>
            {props.userData.email ? props.userData.email : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography className={classes.label}>USER GROUP</Typography>
          <Typography className={classes.value}>
            {props.userData.group == null || undefined
              ? 'N/A'
              : props.userData.group.name}
          </Typography>
        </Grid>
      </Grid>
      <Grid container spacing={5}>
        ...
        <Grid item xs={6}>
          ...
          <Typography className={classes.value}>
            <u>
              {props.userData.hasOwnProperty('group_roles')
                ? props.userData.group_roles.length > 0
                  ? props.userData.group_roles.map(
                      (d: any, i: any) =>
                        `${d.name}${
                          i !== props.userData.group_roles.length - 1
                            ? ', '
                            : ''
                        }`,
                    )
      ...
      <Grid container spacing={5}>
        <Grid item xs={6}>
          ...
          <Typography className={classes.value}>
            <b>
              {props.userData.is_locked && props.userData.is_locked
                ? 'Locked'
                : 'Unlocked'}
            </b>
          </Typography>
        ...
        <Grid item xs={6}>
          ...
          <Typography className={classes.value}>
            <u>
              {props.userData.hasOwnProperty('roles')
                ? props.userData.roles.length > 0
                  ? props.userData.roles.map(
                      (d: any, i: any) =>
                        `${d.name}${
                          i !== props.userData.roles.length - 1 ? ', ' : ''
                        }`,
                    )
                  : 'N/A'
                : 'N/A'}
      ...
      <Grid container spacing={5}>
        <Grid item xs={3}>
          ...
          {props.userData.reports_to ? (
            <>
              <Typography className={classes.value}>
                {props.userData.reports_to.first_name}{' '}
                {props.userData.reports_to.last_name}
              </Typography>
              <Typography style={{ color: 'rgba(60, 57, 74, 0.7)' }}>
                <small>
                  <b>
                    {props.userData.reports_to.job_title
                      ? props.userData.reports_to.job_title
                      : 'N/A'}
                  </b>
                </small>
              ...
              <Typography style={{ color: 'rgba(60, 57, 74, 0.7)' }}>
                <small>
                  <i>
                    {props.userData.reports_to.employee_id
                      ? props.userData.reports_to.employee_id
                      : 'N/A'}
                  </i>
                </small>
      ...
      <Grid container spacing={5} style={{ paddingBottom: 30 }}>
        <Grid item xs={3}>
          ...
          <Typography className={classes.value}>
            {props.userData.effectivity_date
              ? moment(props.userData.effectivity_date).format('MMM DD, YYYY')
              : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={3}>
          ...
          <Typography className={classes.value}>
            {props.userData.expiry_date
              ? moment(props.userData.expiry_date).format('MMM DD, YYYY')
              : 'N/A'}
          </Typography>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={5}>
        ...
        <Grid item xs={3}>
          ...
          <Typography className={classes.value}>
            {props.userData.first_name ? props.userData.first_name : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography className={classes.label}>MIDDLE NAME</Typography>
          <Typography className={classes.value}>
            {props.userData.middle_name ? props.userData.middle_name : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography className={classes.label}>LAST NAME</Typography>
          <Typography className={classes.value}>
            {props.userData.last_name ? props.userData.last_name : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography className={classes.label}>SUFFIX</Typography>
          <Typography className={classes.value}>
            {props.userData.hasOwnProperty('suffix') &&
            props.userData.suffix !== ''
      ...
      <Grid container spacing={5}>
        <Grid item xs={3}>
          ...
          <Typography className={classes.value}>
            {props.userData.employee_id ? props.userData.employee_id : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography className={classes.label}>DEPARTMENT</Typography>
          <Typography className={classes.value}>
            {props.userData.department ? props.userData.department.name : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography className={classes.label}>JOB POSITION / RANK</Typography>
          <Typography className={classes.value}>
            {props.userData.job_title ? props.userData.job_title : 'N/A'}
          </Typography>
        </Grid>
      </Grid>
      <Grid container spacing={5}>
        <Grid item xs={3}>
          ...
          <Typography className={classes.value}>
            {props.userData.section ? props.userData.section : 'N/A'}
          </Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography className={classes.label}>LOCATION</Typography>
          <Typography className={classes.value}>
            {props.userData.location ? props.userData.location : 'N/A'}
          </Typography>
        </Grid>
      </Grid>
      {/* BEGIN MODALS */}
