              ...
              >
                <Grid item xs={12}>
                  <TextFieldWithEyeIcon
                    ...
                    label="Enter your olZd password"
                      ...
                      <>
                        ...
                        >
                          <li>
                            Must be{' '}
                            <strong>
                              {pwValidator.min_length} min to{' '}
                              {pwValidator.max_length} max characters
                            </strong>
                          </li>
                          {pwValidator.character.map((e: any) =>
                            e === 'number' ? (
                              <li>
                                Must have <strong>letters and numbers</strong>
                              </li>
                            ) : e === 'uppercase_letter' ? (
                              <li>
...
const TextFieldWithEyeIcon: React.FC<textFieldProps> = (
  ...
  return (
    <>
      <InputLabel className={classes.inputLabel} htmlFor="role_id">
        {label}
      </InputLabel>
      ...
      <OutlinedInput
        ...
        endAdornment={
          <InputAdornment position="end">
            ...
            >
              {type === 'text' ? (
                <Visibility className={classes.iconEye} />
              ) : (
                <VisibilityOff className={classes.iconEye} />
              )}
            </IconButton>
          </InputAdornment>
        }
