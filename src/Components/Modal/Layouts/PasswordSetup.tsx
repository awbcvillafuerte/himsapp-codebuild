...
export const PasswordSetupModal: React.FC<IProps> = (
  props: IProps,
): JSX.Element => {
  const { open, onClose, onSubmit, setup, id } = props;
      ...
      >
        ...
        <div className={classes.dialogContent}>
          ...
          <div className={classes.instruction}>
            ...
            <span>
              ...
              {setup.character.map(e =>
                e === 'number' ? (
                  <>
                    — Must have <strong>numbers</strong>
                    <br />{' '}
                  </>
                ) : e === 'uppercase_letter' ? (
                  <>
                    — Must have <strong>at least 1 upper case</strong>
                    <br />{' '}
                  </>
                ) : e === 'lowercase_letter' ? (
                  <>
                    — Must have <strong>at least 1 lower case</strong>
                    <br />{' '}
                  </>
                ) : e === 'special_character' ? (
                  <>
                    — Must have <strong>at least 1 special</strong>
                    <br />{' '}
                  </>
                ) : (
                  ''
          ...
          <div>
            ...
            <Grid spacing={6} container className={classes.buttons}>
              ...
              <Grid item xs={6} style={{ textAlign: 'left' }}>
                <Button
                  disabled={
                    RegExp(setup.regex).test(pwData.new_password.value) &&
                    RegExp(setup.regex).test(pwData.conf_password.value)
                      ? pwData.new_password.value === pwData.conf_password.value
                        ? false
                        : true
                      : true
                  }
